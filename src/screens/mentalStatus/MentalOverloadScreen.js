...
const MentalOverloadScreen = ({ navigation }) => {
  return (
      ...
      <ScrollView>
        <View style={styles.content}>
          ...
          <View style={styles.imageContainer}>
            <Image
              source={require('../../../assets/overload.png')}
          ...
          <View style={styles.mainCard}>
            ...
            <Text style={styles.scoreText}>Overload</Text>
            
            {/* Score Indicator */}
            <View style={styles.scoreIndicator}>
              <View style={[styles.currentIndicatorDot, { backgroundColor: '#FF7B85' }]} />
            ...
            <View style={styles.analysisContainer}>
              ...
              <Text style={styles.analysisExplanationText}>
                Your HRV data suggests that your body is under excessive stress. Overloading yourself may lead to burnout or health issues. Consider adjusting your workload, taking more breaks, and improving your recovery habits to prevent long-term stress buildup.
              </Text>
...
export default MentalOverloadScreen;