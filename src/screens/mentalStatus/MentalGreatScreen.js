...
const MentalGreatScreen = ({ navigation }) => {
  return (
        ...
        <View style={styles.content}>
          ...
          <View style={styles.mainCard}>
            ...
            <View style={styles.scoreIndicator}>
              ...
              <View style={[styles.currentIndicatorDot, { backgroundColor: '#7AD0A3' }]} />
            ...
            <View style={styles.analysisContainer}>
              <Text style={styles.analysisText}>
                Your HRV performance during last night's sleep was excellent. Keep up the good work and stay energised for the new day!
              </Text>
              
              <Text style={styles.analysisExplanationText}>
                Your heart rate variability (HRV) data suggests that your body is in a good state of recovery. You're well-rested and ready to take on the day with optimal performance.
              </Text>
...
export default MentalGreatScreen;